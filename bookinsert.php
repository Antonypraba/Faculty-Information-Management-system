                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                        <div class="panele">
                            <div class="panel-body">
                                ...
                                <input type="text" class="form-control" id="First_name" placeholder="" value="" required name="book_title">
                                <br>
                                <label for="faculty_id">Author</label>
                                <input type="text" class="form-control" id="posting" value="" name="book_author">
                                <br>
                                <label for="faculty_id">Publish Details</label>
                                <input type="text" class="form-control" id="posting" value="" name="book_publish_details">
                                <br>
                                <label for="faculty_id">ISSN / ISBN</label>
                                <input type="int" class="form-control" id="posting" value="" name="issn_isbn">
                                <br>
                                ...
                                <input type="text" class="form-control" id="phone" value="" name="book_volume">
                                <br>
                                <label for="aadhar">Pages</label>
                                <input type="text" class="form-control" id="aadhar" value="" name="book_pages">
                                <br>
                                <button name="action" value="insertbook" type="submit" class="btn btn-primary"><i class="fa fa-fw fa-check update"></i>Insert Book</button>
