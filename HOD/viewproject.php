                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-bordered table-striped" id="example-table">
                                <thead>
                                    <tr>
                                        <th>Project Title</th>
                                        <th  class="d-none" >Investigator</th>
                                        <th  class="d-none" >Sanctioned Agency</th>
                                        <th  class="d-none" >Sanctioned Amount</th>
                                ...
                                <tbody>
                                    ...
                                    if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
                                        ...
                                        $query = "SELECT * FROM  projects WHERE year_of_sanctioned  BETWEEN '$from_date' AND '$to_date' AND faculty_id = '$faculty_id'  ";
                                    ...
                                    ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td  class="d-none" ><?php echo $row['project_investigator']; ?> </td>
                                                    <td  class="d-none" ><?php echo $row['sanctioned_agency']; ?> </td>
                                                    <td  class="d-none" >Rs - <?php echo $row['sanctioned_amount']; ?> </td>
                                                    <td><?php echo $row['year_of_sanctioned']; ?> </td>                            
                                                    <td><?php echo $row['project_status']; ?></td>
                                                    <td  class="d-none" ><?php echo $row['duration']; ?></td>
                                                </tr>
                                    <?php
                                            ...
                                            <div class="card-body p-1-9 p-sm-2-3 p-md-6 p-lg-7">
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="proftext">
                                                        <table class="table">
                                                            <tr>
                                                                <td><strong class="strong">Project Title</strong></td>
                                                                <td>:</td>
                                                                <td><i class="idata"><?php echo $row['project_title']; ?></i></td>
                                                            </tr>
                                                            <tr>
                                                                <td><strong class="strong">Investigator</strong></td>
                                                                <td>:</td>
                                                                <td><i class="idata"><?php echo $row['project_investigator']; ?></i></td>
                                                            </tr>
                                                            <tr>
                                                                <td><strong class="strong">Sanctioned Agency</strong></td>
                                                                <td>:</td>
                                                                <td><i class="idata"><?php echo $row['sanctioned_agency']; ?></i></td>
                                                            </tr>
                                                            <tr>
                                                                <td><strong class="strong">Sanctioned Amount</strong></td>
                                                                <td>:</td>
                                                                <td><i class="idata">Rs - <?php echo $row['sanctioned_amount']; ?></i></td>
                                                            </tr>
                                                            <tr>
                                                                <td><strong class="strong">Year of Sanctioned</strong></td>
                                                                <td>:</td>
                                                                <td><i class="idata"><?php echo $row['year_of_sanctioned']; ?></i></td>
                                                            </tr>
                                                            <tr>
                                                                <td><strong class="strong">Status</strong></td>
                                                                <td>:</td>
                                                                <td><i class="idata"><?php echo $row['project_status']; ?></i></td>
                                                            </tr>
                                                            <tr>
                                                                <td><strong class="strong">Duration</strong></td>
                                                                <td>:</td>
                                                                <td><i class="idata"><?php echo $row['duration']; ?></i></td>
                                                            </tr>
            ...
            <div class="card-body">
              <blockquote class="blockquote blockquote-custom bg-white px-5 pt-4">
                ...
                <p class="mb-0 mt-2 font-italic">
                  "There is  "NO"  Project details are available
