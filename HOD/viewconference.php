                                ...
                                <table class="table table-bordered table-striped" id="example-table">
                                    ...
                                    <tbody>
                                        ...
                                        if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
                                            ...
                                            $query = "SELECT * FROM  conference WHERE conference_publication_date  BETWEEN '$from_date' AND '$to_date' AND faculty_id = '$faculty_id'  ";
                                        ...
                                        ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="d-none"><?php echo $row['conference_author']; ?></td>
                                                        <td><?php echo $row['conference_publication_date']; ?></td>
                                                        <td class="d-none"><?php echo $row['conference_volume']; ?></td>
                                                        <td class="d-none"><?php echo $row['conference_pages']; ?></td>
                                                        <td class="d-none"><?php echo $row['conference_issue']; ?></td>
                                                        <td ><?php echo $row['conference_paper_title']; ?></td>
        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class=" font-weight-bold text-primary display-6 "> CONFERENCE DETAILS </h6>
