                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                        <div class="panele">
                            <div class="panel-body">
                                <h3 class="section-title text-primary mb-5 mb-sm-6 display-6 "> <span class="span"> Add Scholar </span></h3>
                                <br>
                                <label for="name">Scholar Name</label>
                                <input type="text" class="form-control" placeholder="" value="" required name="scholar_name">
                                <br>
                                <label for="text">Category</label>
                                <select class="form-control" name="category">
                                    <option selected value="PT Internal">Part Time Internal</option>
                                ...
                                <div class="col-xs-3 pull-left date">
                                    ...
                                    <input type="date" value="" name="Joining_Date" />
                                </div><br>
                                <br><br><br>
                                <div class="col-xs-3 pull-left date">
                                    <label for="aadhar">Viva Date </label><br>
                                    <input type="text" value="" name="viva_date" />
                                </div>
                                <br><br><br><br>
                                <label>Status</label>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="status" id="exampleRadios2" checked value="Purusing">
                                    <label class="form-check-label" for="exampleRadios2">
                                        Purusing
                                    </label><br>
                                    <input class="form-check-input" type="radio" name="status" id="exampleRadios3" value="Completed">
                                ...
                                <input type="text" class="form-control" value="" name="area_of_research">
                                <br>
                                <label for="aadhar">Title</label>
                                <input type="text" class="form-control" value="" name="title_of_the_thesis">
                                <br>
                                <button name="action" value="insertscholar" type="submit" class="btn btn-primary"><i class="fa fa-fw fa-check update"></i>Add</button>
                            </div>
                        </div>
                    </div>
                </div>
