                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                        ...
                        <div class="panele">
                            <div class="panel-body">
                                ...
                                <input type="text" class="form-control" id="First_name" placeholder="" value="" required name="patent_title">
                                <br>
                                <label for="faculty_id">Application number</label>
                                <input type="text" class="form-control" id="posting" value="" name="patent_application_number">
                                <br>
                                <br>
                                <label for="phone">Patent status</label><br>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="patent_status_of_patent" id="flexRadioDefault1" value="Published">
                                    <label class="form-check-label" for="flexRadioDefault1">
                                        Published
                                    </label><br>
                                    <input class="form-check-input" type="radio" name="patent_status_of_patent" id="flexRadioDefault2" checked value="Granted">
                                    <label class="form-check-label" for="flexRadioDefault2">
                                        Granted
                                    </label>
                                </div> <br>
                                <label for="aadhar">Investor</label>
                                <input type="text" class="form-control" id="aadhar" value="" name="patent_investor">
                                <br>
                                <label for="aadhar">Applicant Name</label>
                                <input type="text" class="form-control" id="aadhar" value="" name="patent_applicant_name">
                                <br>
                                <div class="col-xs-3 pull-left date">
                                    <label for="email">Patent Field Date</label>
                                    <input type="date" value=""  name="patent_filed_date"/>
                                </div>
                                <br><br><br><br>
                                <div class="col-xs-3 pull-left date">
                                    <label for="email">Published Date</label>
                                    <input type="date" name="patent_published_date" value=""  />
                                </div>
                                <br><br><br><br>
                               
                                    <label for="email">Publication Number</label>
                                    <input type="text" class="form-control" name="patent_publication_number" value="" />
                             
                                <br>
                                <label for="aadhar">Assignee name / Institute</label>
                                <input type="text" class="form-control" id="aadhar" value="" name="patent_assignie_name_instute">
                                <br>
                                <label for="aadhar">Source of Proof</label>
                                <input type="text" class="form-control" id="aadhar" value="" name="patent_source_of_proof">
                                <br>
                                <button name="action" value="insertpatent" type="submit" class="btn btn-primary"><i class="fa fa-fw fa-check update"></i>Insert</button>
