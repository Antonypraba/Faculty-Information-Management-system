...
<body>
    ...
    <div class="mainbody container-fluid">
        <div class="row">
            ...
            $query1 = mysqli_query($con, "SELECT * FROM journal WHERE journal_id = '$id'");
            $result = mysqli_num_rows($query1);
            ...
            ?>
            <form action="database\update.php<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" value="">
                <input type="int" hidden="true" name="id" value="<?php echo $row['journal_id']; ?>">
                <div class="content">
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                        ...
                        <div class="panele">
                            <div class="panel-body">
                                ...
                                <input type="text" class="form-control" id="First_name" placeholder="" value="<?php echo $row['journal_title']; ?>" required name="journal_title">
                                <br>
                                <label for="faculty_id">Author</label>
                                <input type="text" class="form-control" id="posting" value="<?php echo $row['journal_author']; ?>" name="journal_author">
                                <br>
                                <div class="col-xs-3 pull-left date">
                                    <label for="email">Publication Date</label>
                                    <input type="date" value="<?php echo $row['journal_publication_date']; ?>" name="journal_publication_date" />
                                </div>
                                <br><br><br><br>
                                <label for="aadhar">Volume</label>
                                <input type="text" class="form-control" id="aadhar" value="<?php echo $row['journal_volume']; ?>" name="journal_volume">
                                <br>
                                <label for="phone">Pages</label>
                                <input type="text" class="form-control" id="phone" value="<?php echo $row['journal_pages']; ?>" name="journal_pages">

                                <br>
                                <label for="aadhar">Publisher</label>
                                <input type="text" class="form-control" id="aadhar" value="<?php echo $row['journal_publisher']; ?>" name="journal_publisher">

                                <br>
                                <label for="aadhar">Issue</label>
                                <input type="text" class="form-control" id="aadhar" value="<?php echo $row['journal_issue']; ?>" name="journal_issue">
                                <br>
                                <label for="aadhar">Paper title</label>
                                <input type="text" class="form-control" id="aadhar" value="<?php echo $row['journal_paper_title']; ?>" name="journal_paper_title">
                                <br>
                                <button name="updatejournal" type="submit" class="btn btn-primary"><i class="fa fa-fw fa-check update"></i>Update</button>
