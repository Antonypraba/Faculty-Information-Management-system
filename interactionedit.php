...
<body>
    ...
    $query1 = mysqli_query($con, "SELECT * FROM interactions WHERE interaction_id = '$id'");
    $result = mysqli_num_rows($query1);
    ...
    <div class="mainbody container-fluid">
        <form action="database\update.php" method="POST" value="">
            <input type="int" hidden="true" name="id" value="<?php echo $row['interaction_id']; ?>">
            <div class="content">
                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                    <div class="panele">
                        <div class="panel-body">
                            ...
                            <textarea type="text" class="form-control" id="First_name" placeholder="" value="<?php echo $row['interaction_details']; ?>" required name="interaction_details"><?php echo $row['interaction_details']; ?></textarea>
                            <br>
                            <label for="faculty_id">Inside / Outside University</label>
                            <select class="form-control" name="inner_outing" value="">
                                <option selected value=""><?php echo $row['inner_outing']; ?></option>
                            ...
                            <div class="col-xs-3 pull-left date">
                                <label for="email">Acadamic Year</label>
                                <input type="text" name="interaction_year" value="<?php echo $row['interaction_year']; ?>" placeholder="eg: 1998" />
                            </div><br><br><br>
                            <br>
                            <button name="updateinteraction"  type="submit" class="btn btn-primary"><i class="fa fa-fw fa-check update"></i>Update</button>
