                ...
                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                    <div class="panele">
                        <div class="panel-body">
                            <h3 class="section-title text-primary mb-5 mb-sm-6 display-6 ">Add Project's </h3>
                            <br><br>
                            <label for="name">Project Title</label>
                            <input type="text" class="form-control" placeholder="" value="" name="project_title">
                            <br>
                            <label for="faculty_id">Investigator</label>
                            <input type="text" class="form-control" value="" name="project_investigator">
                            <br>
                            <label for="faculty_id">Sanctioned Agency</label>
                            <input type="text" class="form-control" value="" name="sanctioned_agency">
                            <br>
                            <label for="phone">Sanctioned Amount</label>
                            <input type="text" class="form-control" value="" name="sanctioned_amount">
                            <br>
                            <div class="col-xs-3 pull-left date">
                                <label for="email">Year Of Sanctioned</label>
                                <input type="year" value="" class="form-control" placeholder="Eg: 2015 " name="year_of_sanctioned">
                            </div>
                            <br><br><br><br>
                            <label for="aadhar">Status</label>
                            <input type="text" class="form-control" value="" name="project_status">
                            <br>
                            <label for="aadhar">Duration</label>
                            <input type="text" class="form-control" value="" name="duration">
                            <br>
                            <button name="action" value="insertproject" type="submit" class="btn btn-primary"><i class="fa fa-fw fa-check update"></i>Submit</button>
                        </div>
                    </div>
                </div>
            </div>
