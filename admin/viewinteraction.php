        ...
        <section class="py-5">
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="card mt-4 ">
                        <div class="card-body">
                            <button id="downloadexcel" class="btn btn-success float-right"><i class="fas fa-download fa-sm text-white-50"></i> Export to excel</button>
                            <br><br>
                            <table class="table table-bordered table-striped" id="example-table">
                                ...
                                <tbody>
                                    ...
                                    if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
                                        ...
                                        $query = "SELECT * FROM  interactions WHERE interaction_year  BETWEEN '$from_date' AND '$to_date' AND faculty_id = '$faculty_id'  ";
                                    ...
                                    ?>
                                                ...
                                                <tr>
                                                    <td><?php echo $row['interaction_details']; ?></td>  
                                                    <td ><?php echo $row['inner_outing']; ?> </td>
                                                    <td ><?php echo $row['interaction_year']; ?> </td>
        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class=" font-weight-bold text-primary display-6 "> INTERACTIONS DETAILS </h6>
                                ...
                                <div class="row align-items-center">
                                    <div class="proftext">
                                        <table class="table">
                                            ...
                                            <tr>
                                                <td> <label class="name">Academic Year</label></td>
                                                <td>:</td>
            ...
            <div class="card-body">
              <blockquote class="blockquote blockquote-custom bg-white px-5 pt-4">
                ...
                <p class="mb-0 mt-2 font-italic">
                  "There is  "NO"  Interaction details are available
